  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.assignmentType ||
          (formData.assignmentType === 'user' && !formData.assignedToUserId) ||
          (formData.assignmentType === 'patient' && !formData.assignedToPatientId) ||
          (formData.assignmentType === 'pool' && !formData.assignedToPoolId)) {
