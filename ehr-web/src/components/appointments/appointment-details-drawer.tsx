        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-3 pb-24">
          ...
          <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
            ...
            <div className="grid grid-cols-4 gap-1.5 mb-2">
              <button
                onClick={handleCall}
                className="flex flex-col items-center justify-center gap-1 px-2 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all"
                title="Call patient"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-1 px-2 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-all"
            ...
            <button
              onClick={handleSMS}
              className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-md hover:bg-indigo-100 transition-all text-[11px] font-medium"
              title="Send SMS"
            >
          ...
          <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              <button
                ...
                className="flex items-center justify-center gap-1 px-2 py-1.5 bg-blue-50 text-blue-700 border border-blue-200 rounded-md hover:bg-blue-100 transition-all text-[11px] font-medium"
              ...
              <button
                ...
                className="flex items-center justify-center gap-1 px-2 py-1.5 bg-green-50 text-green-700 border border-green-200 rounded-md hover:bg-green-100 transition-all text-[11px] font-medium"
              ...
              <button
                ...
                className="flex items-center justify-center gap-1 px-2 py-1.5 bg-purple-50 text-purple-700 border border-purple-200 rounded-md hover:bg-purple-100 transition-all text-[11px] font-medium"
          ...
          <div className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-2.5 space-y-1.5 shadow-lg">
            {onStartEncounter && appointment.status === 'scheduled' && (
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all font-medium text-xs shadow-sm"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-all font-medium text-xs shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
