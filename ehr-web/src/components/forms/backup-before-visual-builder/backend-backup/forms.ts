...
// ============================================================================
// Step Validation Rules (Enhanced Rule Engine)
// ============================================================================

export type RuleType = 'validation' | 'visibility' | 'navigation' | 'calculation';
...
export interface RuleCondition {
  field: string; // Dot notation path (e.g., 'patient.age', 'answers.q1')
  operator: RuleOperator;
  value: any;
  logicOperator?: LogicOperator; // For grouped conditions
}
...
export interface RuleAction {
  type: ActionType;
  message?: string; // For error/warning actions
  field?: string; // Target field for set_value/enable_disable
  value?: any; // Value to set or 'show'/'hide', 'enable'/'disable'
  targetStep?: number; // For navigate_to action
  expression?: string; // For calculate action (FHIRPath or simple expression)
}
...
export interface StepRule {
  ...
  createdAt?: string;
  createdBy?: string;
  isConditionalLogic?: boolean; // Flag for system-generated rules
}
...
export interface CreateStepRuleRequest {
  type: RuleType;
  name: string;
  description?: string;
  enabled?: boolean;
...
export interface CreateStepRuleResponse {
  step: FormStep;
  rule: StepRule;
}

export interface GetStepRulesResponse {
  rules: StepRule[];
}

export interface EvaluateStepRulesRequest {
  context: Record<string, any>;
}

export interface TestStepRuleRequest {
  mockData: Record<string, any>;
}
