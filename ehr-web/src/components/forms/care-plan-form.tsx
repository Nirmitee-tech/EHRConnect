    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="flex gap-3 pt-4 border-t border-gray-200">
        <button
          ...
          onClick={handleSave}
          disabled={isSaving}
          className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground text-sm font-medium rounded hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSaving ? (
            <>
