      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="p-3 border-b border-gray-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                >
                  <ExternalLink className="h-3.5 w-3.5 text-primary group-hover:text-primary/80" />
                </button>
              </div>
          ...
          <div className="mt-2 flex items-center gap-1">
            <button className="flex-1 px-2 py-1 border border-primary text-primary rounded text-xs font-medium hover:bg-primary/5 transition-colors">
              SMS/WA
            </button>
            <button className="px-2 py-1 bg-primary text-primary-foreground rounded text-xs hover:opacity-90 transition-colors">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <div>
                <div className="flex items-center gap-1">
                  <span className="font-semibold text-primary">Relationship</span>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <div className="text-right">
                <span className="font-semibold text-primary">Ratecard</span>
            ...
            <div className="flex items-center justify-between text-xs">
              <div>
                <span className="font-semibold text-primary">Membership</span>
                <p className="text-gray-600">-</p>
              </div>
              <div className="text-right">
                <span className="font-semibold text-primary">{membershipType}</span>
                <p className="text-gray-600">-</p>
              </div>
            </div>
        ...
        <div className="border-b border-gray-200">
          ...
          >
            <h3 className="text-xs font-semibold text-primary">Addresses ({addresses.length})</h3>
            {addressExpanded ? (
              ...
              {addresses.length === 0 ? (
                ...
                <div className="space-y-2 mb-2">
                  {addresses.filter(addr => addr.isActive).map((addr) => (
                    <div
                      key={addr.id}
                      className={`p-2 rounded text-xs ${addr.isPrimary ? 'bg-primary/5 border border-primary/20' : 'bg-gray-50'
                        }`}
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <span className={`px-1.5 py-0.5 text-xs font-medium rounded ${addr.type === 'Home' ? 'bg-green-100 text-green-700' :
                            addr.type === 'Work' ? 'bg-primary/10 text-primary' :
        ...
        <div className="px-3 py-2 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-primary">Blood Group</span>
            <div className="flex items-center gap-2">
        ...
        <div className="px-3 py-3 border-b border-gray-200">
          <div className="mb-2">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-semibold text-primary">Payment Due</span>
              <span className="text-sm font-semibold text-gray-900">₹ 0.00</span>
            </div>
          </div>
          <div className="space-y-1.5">
            <button className="w-full px-2 py-1.5 text-xs bg-primary text-primary-foreground rounded hover:opacity-90 transition-colors font-medium">
              Receive Payment
            </button>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md mx-4">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-colors ${patientStatus === 'active'
