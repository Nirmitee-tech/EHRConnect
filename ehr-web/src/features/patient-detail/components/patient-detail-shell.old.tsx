    ...
    <TabPageWrapper title={patient.name} icon={<User className="h-4 w-4" />}>
      <div className="h-screen flex flex-col bg-gray-50">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div
            className={`bg-white border-r border-gray-200 overflow-y-auto transition-all duration-300 ease-in-out flex-shrink-0 ${sidebarCollapsed ? 'w-14' : 'w-48'
              }`}
          >
            {/* Toggle Button */}
                ...
                return (
                  ...
                  >
                    ...
                    {!sidebarCollapsed && hasCount && (
                      <span className={`inline-flex items-center justify-center w-5 h-5 text-xs font-semibold rounded-full ${isActive ? 'bg-white text-primary' : 'bg-green-100 text-green-700'
                        }`}>
                        {section.count}
                      </span>
                    )}
                        ...
                        <div className="ml-auto flex items-center gap-2">
                          <div className="relative">
                            <button
                              ...
                              className="px-3 py-1.5 text-xs font-medium text-white bg-primary hover:bg-primary/80 rounded"
                            >
                              AMC Requires
                            </button>
                            <AmcRequiresPopover
