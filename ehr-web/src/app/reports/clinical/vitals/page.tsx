...
import { HeartPulse, Activity, AlertTriangle, AlertCircle, Users } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12 text-gray-500">
              ...
              <div className="text-xs mt-2">Charts, graphs, and detailed insights for Vital Signs Tracking</div>
            </div>
          </CardContent>
        </Card>
      </div>
