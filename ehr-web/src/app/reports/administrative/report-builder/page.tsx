...
import { FileSpreadsheet, Play, Calendar, TrendingUp } from 'lucide-react';
...
export default function ReportPage() {
  ...
  const reportsRun = Math.floor(reportData.length * 3);
  const scheduledReports = Math.floor(reportData.length * 0.4);
  const mostPopular = 'Patient Summary';
    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card key="1">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-600">Run This Month</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-900">{reportsRun}</div>
                </div>
          ...
          <Card key="2">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-900">{scheduledReports}</div>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12 text-gray-500">
              ...
              <div className="text-xs mt-2">Charts, graphs, and detailed insights for Custom Report Builder</div>
            </div>
          </CardContent>
        </Card>
      </div>
