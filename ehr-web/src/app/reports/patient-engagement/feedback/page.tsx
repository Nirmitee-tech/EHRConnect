...
import { MessageCircle, Star, AlertTriangle, TrendingUp } from 'lucide-react';
...
export default function ReportPage() {
  ...
  const complaintsCount = Math.floor(reportData.length * 0.1);
  const responseRate = (70 + Math.random() * 20).toFixed(0);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card key="2">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-900">{complaintsCount}</div>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12 text-gray-500">
              ...
              <div className="text-xs mt-2">Charts, graphs, and detailed insights for Patient Feedback & Complaints</div>
            </div>
          </CardContent>
        </Card>
      </div>
