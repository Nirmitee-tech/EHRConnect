...
export default function ReportPage() {
  ...
  const overallScore = (70 + Math.random() * 20).toFixed(0);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card key="0">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-600">Measures Tracked</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12 text-gray-500">
              ...
              <div className="text-xs mt-2">Charts, graphs, and detailed insights for HEDIS Quality Measures</div>
            </div>
          </CardContent>
        </Card>
      </div>
