    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Department-level budgeting and cost allocation</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Cost Centers Management</h3>
          <p className="text-gray-600">Configure department-level cost centers and budget allocation</p>
        </div>
      </div>
    </div>
  );
