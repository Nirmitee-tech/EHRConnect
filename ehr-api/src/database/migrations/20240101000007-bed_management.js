...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Bed Management & Hospitalization Module
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000007-bed_management...');
      await pool.query(sql);
      console.log('✅ 20240101000007-bed_management completed');
    } catch (error) {
      console.error('❌ 20240101000007-bed_management failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000007-bed_management.js');
  }
};
