...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Forms Module: Questionnaire Management
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000021-forms_module...');
      await pool.query(sql);
      console.log('✅ 20240101000021-forms_module completed');
    } catch (error) {
      console.error('❌ 20240101000021-forms_module failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000021-forms_module.js');
  }
};
