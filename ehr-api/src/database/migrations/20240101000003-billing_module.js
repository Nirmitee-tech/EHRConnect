...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Billing Module Schema
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000003-billing_module...');
      await pool.query(sql);
      console.log('✅ 20240101000003-billing_module completed');
    } catch (error) {
      console.error('❌ 20240101000003-billing_module failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000003-billing_module.js');
  }
};
