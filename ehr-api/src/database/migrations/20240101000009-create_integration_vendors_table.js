...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Integration Vendors Catalog
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000009-create_integration_vendors_table...');
      await pool.query(sql);
      console.log('✅ 20240101000009-create_integration_vendors_table completed');
    } catch (error) {
      console.error('❌ 20240101000009-create_integration_vendors_table failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000009-create_integration_vendors_table.js');
  }
};
