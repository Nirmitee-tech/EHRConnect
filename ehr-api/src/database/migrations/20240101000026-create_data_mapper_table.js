...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Data Mapper Tables for Integration Field Mapping
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000026-create_data_mapper_table...');
      await pool.query(sql);
      console.log('✅ 20240101000026-create_data_mapper_table completed');
    } catch (error) {
      console.error('❌ 20240101000026-create_data_mapper_table failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000026-create_data_mapper_table.js');
  }
};
