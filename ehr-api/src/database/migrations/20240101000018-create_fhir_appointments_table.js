...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Migration: Create fhir_appointments table
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000018-create_fhir_appointments_table...');
      await pool.query(sql);
      console.log('✅ 20240101000018-create_fhir_appointments_table completed');
    } catch (error) {
      console.error('❌ 20240101000018-create_fhir_appointments_table failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000018-create_fhir_appointments_table.js');
  }
};
