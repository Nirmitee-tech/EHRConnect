...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Migration: Add consent management and vitals capture for virtual meetings
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000032-add_meeting_consent_and_vitals...');
      await pool.query(sql);
      console.log('✅ 20240101000032-add_meeting_consent_and_vitals completed');
    } catch (error) {
      console.error('❌ 20240101000032-add_meeting_consent_and_vitals failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000032-add_meeting_consent_and_vitals.js');
  }
};
