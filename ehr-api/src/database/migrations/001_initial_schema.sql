...
CREATE UNIQUE INDEX IF NOT EXISTS idx_inventory_categories_unique_name ON inventory_categories(org_id, LOWER(name));
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_inventory_suppliers_unique_name ON inventory_suppliers(org_id, LOWER(name));
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_inventory_items_unique_name ON inventory_items(org_id, LOWER(name));
