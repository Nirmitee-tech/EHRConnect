...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const sql = `-- Dashboard snapshot storage for multi-role analytics
...
`;
    ...
    try {
      console.log('🔄 Executing 20240101000006-dashboard_snapshots...');
      await pool.query(sql);
      console.log('✅ 20240101000006-dashboard_snapshots completed');
    } catch (error) {
      console.error('❌ 20240101000006-dashboard_snapshots failed:', error.message);
      throw error;
    } finally {
      await pool.end();
    }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    console.log('⚠️  Rollback not implemented for 20240101000006-dashboard_snapshots.js');
  }
};
