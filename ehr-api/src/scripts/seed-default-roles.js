...
const DEFAULT_ROLES = [
  ...
  // ============================================
  {
    key: 'PATIENT',
    name: 'Patient',
    description: 'Patient self-service access. View own records, schedule appointments, pay bills, message providers, and contribute health data.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',  // Own record only (enforced at application level)
      'patient_demographics:read',
      'patient_demographics:edit',  // Update own contact info
      'patient_documents:read',
      'patient_history:read',
      'appointments:read',
      'appointments:create',  // Self-scheduling
      'appointments:edit',    // Reschedule own appointments
      'encounters:read',
      'observations:read',
      'observations:create',  // Home monitoring data
      'diagnoses:read',
      'procedures:read',
      'medications:read',
      'allergies:read',
      'allergies:edit',  // Update own allergies
      'immunizations:read',
      'lab_results:read',
      'imaging_results:read',
      'prescriptions:read',
  ...
  },
  {
    key: 'CAREGIVER',
    name: 'Caregiver',
    description: 'Proxy access for managing dependent care (children, elderly parents). Requires proper consent and relationship verification.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',  // Dependent records only
      'patient_demographics:read',
      'patient_demographics:edit',
      'patient_history:read',
      'appointments:read',
      ...
      'encounters:read',
      'observations:read',
      'observations:create',  // Record home vitals for dependent
      'diagnoses:read',
      'procedures:read',
      'medications:read',
      'allergies:read',
  ...
  // ============================================
  {
    key: 'CASE_MANAGER',
    name: 'Case Manager',
    description: 'Complex care management for patients with chronic conditions. Coordinate across multiple providers and settings.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patients:edit',
  ...
  },
  {
    key: 'SOCIAL_WORKER',
    name: 'Social Worker',
    description: 'Connect patients with community resources, financial assistance, and support services. Address social determinants of health.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patients:edit',
  ...
  },
  {
    ...
    description: 'Longitudinal care planning, care transitions, referral management, and gap closure. Track care plans across settings.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patients:edit',
  ...
  // ============================================
  {
    key: 'THERAPIST',
    name: 'Therapist',
    description: 'Physical, occupational, speech, and behavioral therapists. Assessment, treatment planning, and progress tracking.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patient_demographics:read',
  ...
  },
  {
    ...
    description: 'Dietitians, respiratory therapists, medical technicians, and other allied health professionals.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patient_demographics:read',
  ...
  // ============================================
  {
    key: 'SCHEDULER',
    name: 'Scheduler',
    description: 'Dedicated appointment scheduling and calendar management. Optimize provider schedules and manage waitlists.',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      ...
      'patient_demographics:edit',
      'appointments:*',
      'staff:read',  // View provider schedules
      'locations:read',
      'departments:read',
      'reports:read',
      'notifications:create',
  ...
  },
  {
    key: 'MEDICAL_CODER',
    name: 'Medical Coder',
    description: 'Code visits and procedures for billing. Ensure compliance with coding standards (ICD-10, CPT).',
    scope_level: 'LOCATION',
    permissions: [
      'patients:read',
      'patient_demographics:read',
      ...
      'encounters:read',
      'diagnoses:read',
      'diagnoses:edit',  // Correct diagnosis codes
      'procedures:read',
      'procedures:edit',  // Add procedure codes
      'clinical_notes:read',
      'billing:read',
      'billing:edit',
      'invoices:read',
  ...
  // ============================================
  {
    ...
    description: 'Nursing operations oversight. Monitor quality metrics, staff performance, and clinical workflows.',
    scope_level: 'ORG',
    permissions: [
      'org:read',
      'locations:read',
  ...
  },
  {
    key: 'CLINIC_MANAGER',
    name: 'Clinic Manager',
    description: 'Clinical operations management. Oversee clinic performance, staff scheduling, and operational efficiency.',
    scope_level: 'LOCATION',
    permissions: [
      'org:read',
      'locations:read',
  ...
  },
  {
    ...
    description: 'Executive leadership with full operational visibility. Strategic planning, KPI monitoring, and cross-organizational oversight.',
    scope_level: 'ORG',
    permissions: [
      'org:read',
      'org:edit',
  ...
  // ============================================
  {
    ...
    description: 'System administration, user management, security configuration, and technical troubleshooting.',
    scope_level: 'ORG',
    permissions: [
      'org:read',
      'locations:*',
      ...
      'audit:*',
      'notifications:*',
      'patients:read',  // For support purposes only
      'reports:read',
      'reports:export',
    ],
    is_system: true,
  },
  {
    ...
    description: 'Manage EHR integrations, APIs, HL7/FHIR interfaces, and data exchange with external systems.',
    scope_level: 'ORG',
    permissions: [
      'org:read',
      'locations:read',
  ...
  // ============================================
  {
    key: 'RESEARCHER',
    name: 'Researcher',
    description: 'Access de-identified data for research, quality improvement, and clinical trials. Must comply with IRB protocols.',
    scope_level: 'ORG',
    permissions: [
      'patients:read',  // De-identified only
      'patients:export',
      'patient_demographics:read',
      'appointments:read',
      'encounters:read',
  ...
  },
  {
    ...
    description: 'Analyze population health trends, identify care gaps, manage registries, and support quality reporting.',
    scope_level: 'ORG',
    permissions: [
      'org:read',
      'locations:read',
