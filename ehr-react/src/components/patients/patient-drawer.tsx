...
import { Sheet as Drawer, SheetContent as DrawerContent } from '@/components/ui/sheet';
    ...
    try {
      ...
      if ((isEditing && 'id' in data) || (isUpdate && patientId)) {
        ...
        if (isUpdate && patientId) {
          ...
          // Note: In React Router, parent component should handle refresh via onSuccess callback
        }
      } else {
