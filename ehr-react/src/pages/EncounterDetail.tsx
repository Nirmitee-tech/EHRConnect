...
import type { Encounter, AddressData, NoteData, InsuranceData } from '@/types/encounter';
    ...
    try {
      ...
      if (data.patientId) {
        try {
          ...
          try {
            const patientResponse = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/fhir/R4/Patient/${data.patientId}`, {
              credentials: 'include',
            });
