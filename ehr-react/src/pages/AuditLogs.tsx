...
import type { AuditEventFilters } from '@/services/audit.service';
import { AuditService } from '@/services/audit.service';
import type { AuditChange, AuditEvent, AuditSettingsMap } from '@/types/audit';
...
export default function AuditLogsPage() {
  ...
  const sessionUserId =
    typeof session?.user === 'object' && session?.user && 'id' in user
  ...
  useEffect(() => {
    if (!isAuthenticated?.org_id && session?.user?.email) {
