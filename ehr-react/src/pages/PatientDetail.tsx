...
import { PatientHeader } from '@/pages/patient-detail/PatientHeader';
import { OverviewTab } from '@/pages/patient-detail/tabs/OverviewTab';
import { VitalsTab } from '@/pages/patient-detail/tabs/VitalsTab';
import { EncountersTab } from '@/pages/patient-detail/tabs/EncountersTab';
import { ProblemsTab } from '@/pages/patient-detail/tabs/ProblemsTab';
import { MedicationsTab } from '@/pages/patient-detail/tabs/MedicationsTab';
import { AllergiesTab } from '@/pages/patient-detail/tabs/AllergiesTab';
import { DocumentsTab } from '@/pages/patient-detail/tabs/DocumentsTab';
import { VitalsDrawer } from '@/pages/patient-detail/drawers/VitalsDrawer';
import { ProblemDrawer } from '@/pages/patient-detail/drawers/ProblemDrawer';
import { MedicationDrawer } from '@/pages/patient-detail/drawers/MedicationDrawer';
import type { PatientDetails, VitalsFormData, ProblemFormData, MedicationFormData } from '@/pages/patient-detail/types';
