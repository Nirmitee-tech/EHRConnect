...
import type { CalendarView, Appointment, AppointmentStats } from '@/types/appointment';
...
import type { EventCategory } from '@/components/appointments/event-filters';
import { EventFilters } from '@/components/appointments/event-filters';
    ...
    <div className="flex h-screen flex-col bg-gray-50">
      ...
      <AppointmentDetailsDrawer
        ...
        onCreateSuperbill={(apt) => {
          navigate(`/billing/claims/new?appointmentId=${apt.id}`);
        }}
      />
    </div>
  );
